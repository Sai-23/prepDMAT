...
export default async function PracticePage({
  ...
  const libraryIntro = <>
    <div data-practice-library-heading>
    ...
    <div className="border-t border-workspace-separator pt-6" data-core-modules-heading>
  ...
  return (
    ...
    >
      {loadError || !performance ? (
        <div className="space-y-8">{libraryIntro}<ErrorState title="Practice is not ready" description={loadError ?? "Unable to load practice."} /></div>
      ) : (
        <PracticeExperience initialConfig={initialConfig} initialSession={initialSession} libraryIntro={libraryIntro} performance={performance} />
      )}
    </PageShell>
  );
}
