...
export const EQUATION_RELATIONSHIP_REGISTRY: readonly RelationshipDefinition[] = [
  ...
  { id: "scale_offset_add", evidence: "official_composition", productionEnabled: true, parentCount: 1 },
  { id: "scale_offset_subtract", evidence: "official_composition", productionEnabled: true, parentCount: 1 },
  ...
  { id: "reverse_difference", evidence: "official", productionEnabled: true, parentCount: 1 },
  ...
  { id: "weighted_difference", evidence: "official_composition", productionEnabled: true, parentCount: 1 },
  { id: "both_sides", evidence: "official_composition", productionEnabled: true, parentCount: 1 },
  { id: "multi_variable_sum", evidence: "official_composition", productionEnabled: true, parentCount: 2 },
  { id: "three_variable_difference", evidence: "official_composition", productionEnabled: true, parentCount: 2 },
  { id: "mixed_three_variable", evidence: "official_composition", productionEnabled: true, parentCount: 2 },
